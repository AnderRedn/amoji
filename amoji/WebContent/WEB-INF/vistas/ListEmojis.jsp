...
<link
	href="${pageContext.request.contextPath}/resources/css/listaEmojisStyle.css"
	rel="stylesheet">
<script src="http://code.jquery.com/jquery-3.4.1.min.js"
	integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo="
	crossorigin="anonymous"></script>
<script
	src="${pageContext.request.contextPath}/resources/js/listaEmojisJS.js"></script>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Lista de Emoticonos</title>
</head>
<body>
	<div class="container-fluid">
		<div id="idContent" class="vertical-center text-center justify-content-center">
		<!-- style="outline: 1px black solid" -->
			...
			<div>
				<div id="idFuntions" class="d-flex justify-content-around">
					<div>
						<a id="idButtonAdd" class="btn btnAdd btn-light" href="anadirnuevo.htm">
					...
					<a class="btnUndo btn btn-light" href="/amoji/listemojis.htm">
							<i class="fa fa-undo" aria-hidden="true"></i>
						</a>
					<!-- form class="form-inline">
						<label class="my-1 mr-2" id="labelFilter" for="idFilter">Filtrar</label>
						...
						<tbody>
							<c:forEach items="${listado}" var="registro">
								<tr>
									...
									<td><span
										id='emoji<c:out value="${registro.idEmoticon}"/>'><c:out
												value="${registro.emoticon}"></c:out></span></td>
									<td><button
											id='emoji<c:out value="${registro.idEmoticon}"/>'
											type="button" class="btn fa fa-clipboard"
