...
<link href="${pageContext.request.contextPath}/resources/css/actualizarEmoticonoStyle.css" rel="stylesheet">
		...
		<div id="idContent" class="vertical-center justify-content-center">
			...
			<div class="justify-content-center">
				...
				<form:form cssClass="form" modelAttribute="emojiUpd">
					...
					<br>
					<form:label cssClass="label" path="emoticon">Emoticono: </form:label>
					<form:input cssClass="input" id="emoticon" path="emoticon" required="required" />
					<br>
